...
{
  config = lib.mkIf config.my.gaming {
    ...
    #   gamemode -> polkit rules + wrapper CAP_SYS_NICE. Tanpa itu gamemoded
    #               tidak boleh menurunkan niceness atau mengganti CPU governor,
    #               jadi `gamemoderun` jalan tanpa melakukan apa-apa.
    programs.steam = {
      enable = true;
